...
export default function GameScreen() {
  ...
  return (
    <>
       {gameStatus === GameState.start ? <canvas
          ref={canvasRef}
          className='border border-dark w-100 h-75'
          width={canvasWidth + 1}
          height={canvasHeight + 1}
        /> : gameStatus === GameState.gameover ? <GameOver/> : <Leaderboard/>}
        
       <ScoreBoard startGame={startGame} score={score} highscore={highscore}/>
    </>
  )
}